...
INSERT INTO `audit_log` (`log_id`, `user_id`, `item_id`, `actual_value`, `passed`, `notes`, `checked_at`) VALUES
	(694, 3, 1, '{"screenSaverTime": "600", "screenSaverSecure": "1", "screenSaverEnabled": "1"}', 1, '화면 보호기가 정상적으로 설정되어 있습니다.', '2025-05-28 15:08:34'),
	(695, 3, 2, '{"UpToDate": 0, "DisplayName": "백신 미설치", "RealTimeProtection": 0}', 0, '알약 백신이 정상적으로 설치되어 있지 않거나, 실시간 보호가 비활성화되어 있거나, 업데이트가 최신 상태가 아닙니다. 알약 백신을 설치하고 실시간 보호를 활성화한 후 최신 업데이트를 적용해주세요.', '2025-05-28 15:08:26'),
	(696, 3, 3, '{"minimumPasswordLength": "8"}', 1, '암호 길이가 정책에 맞게 설정되어 있습니다.', '2025-05-28 15:08:45'),
	(697, 3, 4, '{"passwordComplexity": "1"}', 1, '암호 복잡도가 적절하게 설정되어 있습니다.', '2025-05-28 15:08:45'),
	(698, 3, 5, '{"maximumPasswordAge": "91"}', 1, '암호 변경 주기가 적절하게 설정되어 있습니다.', '2025-05-28 15:08:45'),
	(699, 3, 6, '{"passwordHistorySize": "5"}', 1, '동일 암호 사용 제한이 적절하게 설정되어 있습니다.', '2025-05-28 15:08:45'),
	(700, 3, 7, '{"folders": ["ADMIN$", "C$", "D$", "E$", "F$", "IPC$"]}', 1, '불필요한 공유 폴더가 있습니다. 필요하지 않은 공유 폴더를 제거해주세요.', '2025-05-28 15:08:48'),
	(701, 3, 8, '{"fDenyTSConnections": 1}', 1, '원격 데스크톱이 적절하게 제한되어 있습니다.', '2025-05-28 15:08:52'),
	(702, 3, 1, '{"screenSaverTime": "600", "screenSaverSecure": "1", "screenSaverEnabled": "1"}', 1, '화면 보호기가 정상적으로 설정되어 있습니다.', '2025-05-27 15:11:18'),
	(703, 3, 2, '{"UpToDate": 0, "DisplayName": "백신 미설치", "RealTimeProtection": 0}', 0, '알약 백신이 정상적으로 설치되어 있지 않거나, 실시간 보호가 비활성화되어 있거나, 업데이트가 최신 상태가 아닙니다. 알약 백신을 설치하고 실시간 보호를 활성화한 후 최신 업데이트를 적용해주세요.', '2025-05-27 15:11:11'),
	(704, 3, 3, '{"minimumPasswordLength": "8"}', 1, '암호 길이가 정책에 맞게 설정되어 있습니다.', '2025-05-27 15:11:28'),
	(705, 3, 4, '{"passwordComplexity": "1"}', 1, '암호 복잡도가 적절하게 설정되어 있습니다.', '2025-05-27 15:11:28'),
	(706, 3, 5, '{"maximumPasswordAge": "91"}', 1, '암호 변경 주기가 적절하게 설정되어 있습니다.', '2025-05-27 15:11:28'),
	(707, 3, 6, '{"passwordHistorySize": "5"}', 1, '동일 암호 사용 제한이 적절하게 설정되어 있습니다.', '2025-05-27 15:11:28'),
	(708, 3, 7, '{"folders": ["ADMIN$", "C$", "D$", "E$", "F$", "IPC$"]}', 1, '불필요한 공유 폴더가 있습니다. 필요하지 않은 공유 폴더를 제거해주세요.', '2025-05-27 15:11:31'),
	(709, 3, 8, '{"fDenyTSConnections": 1}', 1, '원격 데스크톱이 적절하게 제한되어 있습니다.', '2025-05-27 15:11:34'),
	(710, 3, 1, '{"screenSaverTime": "600", "screenSaverSecure": "1", "screenSaverEnabled": "1"}', 1, '화면 보호기가 정상적으로 설정되어 있습니다.', '2025-05-29 15:13:23'),
	(711, 3, 2, '{"UpToDate": 0, "DisplayName": "백신 미설치", "RealTimeProtection": 0}', 1, '알약 백신이 정상적으로 설치되어 있지 않거나, 실시간 보호가 비활성화되어 있거나, 업데이트가 최신 상태가 아닙니다. 알약 백신을 설치하고 실시간 보호를 활성화한 후 최신 업데이트를 적용해주세요.', '2025-05-29 15:13:15'),
	(712, 3, 3, '{"minimumPasswordLength": "8"}', 1, '암호 길이가 정책에 맞게 설정되어 있습니다.', '2025-05-29 15:13:35'),
	(713, 3, 4, '{"passwordComplexity": "1"}', 1, '암호 복잡도가 적절하게 설정되어 있습니다.', '2025-05-29 15:13:35'),
	(714, 3, 5, '{"maximumPasswordAge": "91"}', 1, '암호 변경 주기가 적절하게 설정되어 있습니다.', '2025-05-29 15:13:35'),
	(715, 3, 6, '{"passwordHistorySize": "5"}', 1, '동일 암호 사용 제한이 적절하게 설정되어 있습니다.', '2025-05-29 15:13:35'),
	(716, 3, 7, '{"folders": ["ADMIN$", "C$", "D$", "E$", "F$", "IPC$"]}', 0, '불필요한 공유 폴더가 있습니다. 필요하지 않은 공유 폴더를 제거해주세요.', '2025-05-29 15:13:38'),
	(717, 3, 8, '{"fDenyTSConnections": 1}', 1, '원격 데스크톱이 적절하게 제한되어 있습니다.', '2025-05-29 15:13:43');
...
INSERT INTO `checklist_items` (`item_id`, `category`, `item_name`, `description`) VALUES
	...
	(2, '접근 통제', '백신 상태 확인', '백신이 설치되어 있는지 확인'),
	(3, '계정 관리', '패스워드 길이의 적정성', '비인가자의 접근제한을 위해 패스워드는 최소 길이 이상 설정해야한다.'),
	(4, '계정 관리', '패스워드 복잡도 설정', '비인가자의 접근제한을 위해 패스워드는 2가지 이상의 복잡도를 만족해야한다.'),
	(5, '계정 관리', '패스워드 주기적 변경', '안전한 패스워드 관리를 위해 패스워드는 주기적으로 변경해야한다.'),
	(6, '계정 관리', '동일 패스워드 설정 제한', '패스워드 변경 시 최근 사용했던 동일한 암호설정은 제한한다.'),
	(7, '네트워크 점검', '공유폴더 확인', '불필요한 파일 공유는 제한해야한다.'),
	(8, '네트워크 점검', '원격데스크톱 제한', '외부에서 접근이 가능한 원격접속기능은 해제 해야한다.');
